...
export const LIMIT_KEY_SCOPES: Record<LimitKey, LimitScope> = {
	...
	max_guild_soundboard_sounds_more: 'guild',
...
export const LIMIT_KEY_METADATA: Record<LimitKey, LimitKeyMetadata> = {
	...
	max_guild_soundboard_sounds: {
		...
		description: 'Maximum soundboard sounds per guild',
		category: 'expressions',
		scope: 'guild',
		isToggle: false,
		unit: 'count',
	...
	max_guild_soundboard_sounds_more: {
		key: 'max_guild_soundboard_sounds_more',
		label: 'Max Soundboard Sounds (More Soundboard)',
		description: 'Maximum soundboard sounds per guild when the MORE_SOUNDBOARD feature is enabled',
		category: 'expressions',
		scope: 'guild',
		isToggle: false,
		unit: 'count',
