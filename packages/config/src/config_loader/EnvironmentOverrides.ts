...
const NAMED_FLUXER_ENV_OVERRIDES: Record<string, NamedEnvOverride> = {
	...
	FLUXER_EASYPWNED_ENABLED: {path: ['integrations', 'easypwned', 'enabled'], parse: parseEnvValue},
	FLUXER_EASYPWNED_URL: {path: ['integrations', 'easypwned', 'url']},
	FLUXER_EASYPWNED_FAIL_OPEN: {path: ['integrations', 'easypwned', 'fail_open'], parse: parseEnvValue},
	FLUXER_SENTRY_ENABLED: {path: ['integrations', 'sentry', 'enabled'], parse: parseEnvValue},
	FLUXER_SENTRY_CLIENT_ENABLED: {path: ['integrations', 'sentry', 'client_enabled'], parse: parseEnvValue},
	FLUXER_SENTRY_DSN: {path: ['integrations', 'sentry', 'dsn']},
	FLUXER_SENTRY_ENVIRONMENT: {path: ['integrations', 'sentry', 'environment']},
	...
	FLUXER_APP_STATUS_PAGE_INCIDENT_HISTORY_URL: {
		path: ['instance', 'branding', 'status_page_incident_history_url'],
	},
