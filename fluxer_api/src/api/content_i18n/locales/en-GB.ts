...
const CONTENT_I18N_EN_GB_MESSAGES = defineContentI18nLocaleMessages({
	...
	'bulk_message_deletion.complete':
		"We've finished deleting your messages. We removed {message_count, plural, =0 {0 messages} one {# message} other {# messages}} from {channel_count, plural, =0 {0 places} one {# place} other {# places}}.",
